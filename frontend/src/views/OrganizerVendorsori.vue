          ...
          <table class="table align-items-center mb-0">
            ...
            <tbody>
              ...
              >
                ...
                <td>
                  <!-- <p class="text-xs text-secondary mb-0">{{ service.user_id }}</p> -->
                  <p class="text-xs text-secondary mb-0">{{ service.user_id ? service.user_id : 'N/A' }}</p>
                </td>
                <td>
    ...
    <div v-if="showModal" class="modal-backdrop">
      <div class="modal-container card p-4">
        ...
        <div class="mb-3">
          ...
          <p class="text-sm">{{ selectedService.user_id }}</p>
        </div>
        <div class="mb-3">
